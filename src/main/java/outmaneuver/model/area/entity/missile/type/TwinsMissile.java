 ...
 */
public final class TwinsMissile extends MissileImpl {

    private final List<Missile> launched = new ArrayList<>();
    ...
    @Override
    public List<Missile> getSpawnOnInit() { return launched; }
